...
export default function BasketCart(props) {
  ...
  return (
    ...
    //     <img src={product.img} alt={product.name} width="90" />
    //     <p>{product.name}</p>
    //     <p>
    //       <div className="button-wrapper">
    //         <div>
    //           <button
    //             onClick={() => decreaseQuantity(cartedItem)}
    //             className="product-button"
    //           >
    //             -
    //           </button>
    //         </div>
    //         <span>{cartedItem.quantity}</span>
    //         <div>
    //           <button
    ...
    //       </div>
    //     </p>
    //     <p>Item total: £{(cartedItem.quantity * product.price).toFixed(2)}</p>
    //     <button
    //       onClick={() => removeCartItem(cartedItem)}
